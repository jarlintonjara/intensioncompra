<template>
    <aside class="page-sidebar" style="background-image: none; background-color: #e30025;">
        <div><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 88 82" class="d-inline-block align-top logo">
                <defs></defs>
                <path fill="#E30025" d="M0 82h88V0H0v82z"></path>
                <path fill="#FFF"
        ...
        <nav id="js-primary-nav" class="primary-nav" role="navigation">
            ...
            <ul class="nav-menu" id="js-nav-menu">
                ...
                <li class="active open" v-if="user.role_id != 9">
                    ...
                    <ul>
                        <router-link tag="li" to="/registro" v-if="user.role_id == 1 || user.role_id == 6"
                            active-class="active">
                            <a href="">
                                <span class="nav-link-text" translate="no">Nuevo Registro</span>
                            </a>
                        </router-link>
                        <router-link tag="li" to="/no-asignado"
                            v-if="user.role_id == 1 || user.role_id == 2 || user.role_id == 3 || user.role_id == 4 || user.role_id == 5 || user.role_id == 6 || user.role_id == 8"
                            active-class="active">
                            <a href="">
                ...
                <li class="active open"
                    ...
                    <ul>
                        ...
                        <router-link v-if="user.role_id != 9" tag="li" to="/bloqueado" active-class="active">
                            <a href="">
                ...
                <router-link tag="li" to="/auditoria"
                    v-if="user.role_id == 6 || user.role_id == 2 || user.role_id == 3">
                    <a href="#">
                        <i class="fal fa-info-circle"></i>
