    ...
    <main id="js-page-content" role="main" class="page-content">
        ...
        <div class="subheader">
            <h1 class="subheader-title">
                <i class='subheader-icon fal fa-list'></i> <span class='fw-300'>RESERVADOS</span>
            </h1>
        </div>
        ...
        <div class="col-lg-12">
            <div id="panel-4" class="panel">
                <div class="panel-hdr">
                    <h2>
                        <h2 style="text-align: center; font-size: 1.125rem;"><b>Registros reservados </b></h2>
                    </h2>
                        ...
                        <table id="tasignado" class="table table-bordered table-hover table-striped w-100">
                            ...
                            <tbody>
                                <tr v-for="asignado in asignados" :key="asignado.id">
                                    <td><button type="button" class="btn btn-xs btn-danger waves-effect waves-themed">Reservado</button></td>
