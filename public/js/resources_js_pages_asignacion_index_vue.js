    ...
    return {
      ...
      dropzoneOptions: {
        ...
        accept: function accept(file, done) {
          ...
          if (file.type.toLowerCase() != "image/jpg" && file.type.toLowerCase() != "image/gif" && file.type.toLowerCase() != "image/jpeg" && file.type.toLowerCase() != "application/pdf" && file.type.toLowerCase() != "image/png") {
            done("Invalid file");
          } else {
            done();
          }
                ...
                _c(
                  ...
                  [
                    ...
                    _c("vue-dropzone", {
                      ...
                      on: { "vdropzone-success": _vm.handleResponse },
                    }),
                  ],
                  1
                ),
