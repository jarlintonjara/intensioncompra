...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
            ...
            while (1) {
              switch (_context4.prev = _context4.next) {
                case 0:
                  ...
                  _context4.next = 3;
                  return _this5.axios["delete"]("/api/concesionario/".concat(id)).then(function (response) {
                    var index = _this5.concesionarios.map(function (e) {
                      return e.id;
                    }).indexOf(id);

                    if (index !== -1) {
                      var concesionarios = _this5.concesionarios;
                      concesionarios.splice(index, 1);
                      _this5.concesionarios = [].concat(concesionarios);
                    }

                    _this5.$swal.fire('Registro eliminado', '', 'success');
                  })["catch"](function (error) {
                    console.log(error);
                  });
  ...
  }, _defineProperty(_methods, "abrirModalCrear", function abrirModalCrear() {
    this.datos = {
      nombre: '',
      descripcion: '',
      direccion: ''
  ...
  }), _defineProperty(_methods, "abrirModalEditar", function abrirModalEditar(datos) {
